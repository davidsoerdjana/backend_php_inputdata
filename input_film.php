				...
				<div class="col-lg-12">
					<section class="panel">
						...
						<div class="panel-body">
							<div class="form">
								<form class="cmxform form-horizontal" method="post" action="proses_film.php" enctype="multipart/form-data" novalidate="novalidate">
									<!--untuk input judul berita  -->
									<div class="form-group">
										<label for="cname" class="control-label col-lg-3">JUDUL FILM</label>
										<div class="col-lg-6">
									...
									<div class="form-group">
										<label for="cmail" class="control-label col-lg-3">GAMBAR FILM</label>
										<div class="col-lg-6">
									...
									<div class="form-group">
										<label for="ccomment" class="control-label col-lg-3">ISI FILM</label>
										<div class="col-lg-6">
